...
int main(int argc, char** argv) {
    ...
    if (plyr1.size()==1||plyr2.size()==1) {
        if (plyr1.size()>plyr2.size()) {
            cout<<"ALL CARDS ELIMINATED!"<<endl<<endl;
            ...
            bin.write(reinterpret_cast<char *>(&p2scor), sizeof(p2scor));
        }
        else {
            cout<<"ALL CARDS ELIMINATED!"<<endl<<endl;
            ...
            bin.write(reinterpret_cast<char *>(&p1scor), sizeof(p1scor));
        }
    }
    else {
        secRnd.points();
        if (p1scor>p2scor) {
            ...
            cout<<plyNum.getNme2()<<" lost!"<<endl;
            out<<endl<<plyNum.getNme1()<<" won!"<<endl;
            out<<plyNum.getNme2()<<" lost!"<<endl;
            out<<plyNum.getNme1()<<" score: "<<p1scor<<endl;
            out<<plyNum.getNme2()<<" score: "<<p2scor<<endl;            
            bin.write(name1, sizeof(name1));
            bin.write(reinterpret_cast<char *>(&p1scor), sizeof(p1scor));
            ...
            cout<<plyNum.getNme1()<<" lost!"<<endl;
            out<<endl<<plyNum.getNme2()<<" won!"<<endl;
            out<<plyNum.getNme1()<<" lost!"<<endl;
            out<<plyNum.getNme2()<<" score: "<<p2scor<<endl;
            out<<plyNum.getNme1()<<" score: "<<p1scor<<endl;            
            bin.write(name2, sizeof(name2));
            bin.write(reinterpret_cast<char *>(&p2scor), sizeof(p2scor));
