...
void rytFile(Player, fstream &out, fstream &bin, short, short, vector<string> &, vector<string> &);
...
int main(int argc, char** argv) {
    ...
    fstream out, bin;        //File stream out
    out.open("Records.txt", ios::out | ios::app);   //Write results to a file
    //bin.open("Records.dat", ios::out | ios::binary | ios::app);
 /*   if (plyr1.size()==1||plyr2.size()==1) {
        if (plyr1.size()>plyr2.size()) {
            out<<plyNum.getNme2()<<" WINS!"<<endl;
            out<<plyNum.getNme1()<<" is the MONKEY!"<<endl;
            out<<plyNum.getNme2()<<" score: "<<p2scor<<endl;
            out<<plyNum.getNme1()<<" score: "<<p1scor<<endl;
            out<<"ALL CARDS ELIMINATED!"<<endl;
          //  bin.write(name2, sizeof(name2));
          //  bin.write(reinterpret_cast<char *>(ps2), sizeof(ps2));
        }
        else {
            out<<plyNum.getNme1()<<" WINS!"<<endl;
            out<<plyNum.getNme2()<<" is the MONKEY!"<<endl;
            out<<plyNum.getNme1()<<" score: "<<p1scor<<endl;
            out<<plyNum.getNme2()<<" score: "<<p2scor<<endl;
            out<<"ALL CARDS ELIMINATED!"<<endl;
//            bin.write(name1, sizeof(name1));
  //          bin.write(reinterpret_cast<char *>(ps1), sizeof(ps1));
        }
    }
    else {
        if (p1scor>p2scor) {
            out<<endl<<plyNum.getNme1()<<" won!"<<endl;
            out<<endl<<plyNum.getNme2()<<" lost!"<<endl;
            out<<plyNum.getNme1()<<" score: "<<p1scor<<endl;
            out<<plyNum.getNme2()<<" score: "<<p2scor<<endl;
        //    bin.write(name1, sizeof(name1));
          //  bin.write(reinterpret_cast<char *>(ps1), sizeof(ps1));
            ...
            out<<endl<<plyNum.getNme2()<<" won!"<<endl;
            out<<endl<<plyNum.getNme1()<<" lost!"<<endl;
            out<<plyNum.getNme2()<<" score: "<<p2scor<<endl;
            out<<plyNum.getNme1()<<" score: "<<p1scor<<endl;
        //    bin.write(name2, sizeof(name2));
          //  bin.write(reinterpret_cast<char *>(ps2), sizeof(ps2));
    ...
    //bin.close();
    out.close();
  //  rytFile(plyNum, out, bin, p1scor, p2scor, plyr1, plyr2);*/
    
    if (plyr1.size()==1||plyr2.size()==1) {
        if (plyr1.size()>plyr2.size()) {
            cout<<endl<<plyNum.getNme2()<<" WINS!"<<endl;
            cout<<plyNum.getNme1()<<" is the MONKEY!"<<endl;
            cout<<plyNum.getNme2()<<" score: "<<p2scor<<endl;
            cout<<plyNum.getNme1()<<" score: "<<p1scor<<endl;
            ...
            cout<<endl<<plyNum.getNme1()<<" WINS!"<<endl;
            cout<<plyNum.getNme2()<<" is the MONKEY!"<<endl;
            cout<<plyNum.getNme1()<<" score: "<<p1scor<<endl;
            cout<<plyNum.getNme2()<<" score: "<<p2scor<<endl;
            cout<<"ALL CARDS ELIMINATED!"<<endl;
            out<<plyNum.getNme1()<<" WINS!"<<endl;
        ...
        secRnd.points();
        if (p1scor>p2scor) {
            cout<<endl<<plyNum.getNme1()<<" won!"<<endl;
            cout<<endl<<plyNum.getNme2()<<" lost!"<<endl;
            out<<endl<<plyNum.getNme1()<<" won!"<<endl;
            out<<endl<<plyNum.getNme2()<<" lost!"<<endl;
            out<<plyNum.getNme1()<<" score: "<<p1scor<<endl;
            out<<plyNum.getNme2()<<" score: "<<p2scor<<endl;
            ...
            cout<<endl<<plyNum.getNme2()<<" won!"<<endl;
            cout<<endl<<plyNum.getNme1()<<" lost!"<<endl;
            out<<endl<<plyNum.getNme2()<<" won!"<<endl;
            out<<endl<<plyNum.getNme1()<<" lost!"<<endl;
            out<<plyNum.getNme2()<<" score: "<<p2scor<<endl;
            out<<plyNum.getNme1()<<" score: "<<p1scor<<endl;
    ...
    cout<<"\nData written to a file!"<<endl<<endl;
...
void rytFile(Player p, fstream &out, fstream &bin, short ps1, short ps2, vector<string> &p1, vector<string> &p2) {
   // char name1[80]=p.getNme1();
  //  char name2[80]=p.getNme2();
    out.open("Records.txt", ios::out | ios::app);   //Write results to a file
    //bin.open("Records.dat", ios::out | ios::binary | ios::app);
    if (p1.size()==1||p2.size()==1) {
        if (p1.size()>p2.size()) {
            out<<p.getNme2()<<" WINS!"<<endl;
            out<<p.getNme1()<<" is the MONKEY!"<<endl;
            out<<p.getNme2()<<" score: "<<ps2<<endl;
            out<<p.getNme1()<<" score: "<<ps1<<endl;
            out<<"ALL CARDS ELIMINATED!"<<endl;
          //  bin.write(name2, sizeof(name2));
          //  bin.write(reinterpret_cast<char *>(ps2), sizeof(ps2));
        }
        else {
            out<<p.getNme1()<<" WINS!"<<endl;
            out<<p.getNme2()<<" is the MONKEY!"<<endl;
            out<<p.getNme1()<<" score: "<<ps1<<endl;
            out<<p.getNme2()<<" score: "<<ps2<<endl;
            out<<"ALL CARDS ELIMINATED!"<<endl;
//            bin.write(name1, sizeof(name1));
  //          bin.write(reinterpret_cast<char *>(ps1), sizeof(ps1));
        ...
        if (ps1>ps2) {
            out<<endl<<p.getNme1()<<" won!"<<endl;
            out<<endl<<p.getNme2()<<" lost!"<<endl;
            out<<p.getNme1()<<" score: "<<ps1<<endl;
            out<<p.getNme2()<<" score: "<<ps2<<endl;
        //    bin.write(name1, sizeof(name1));
          //  bin.write(reinterpret_cast<char *>(ps1), sizeof(ps1));
            ...
            out<<endl<<p.getNme2()<<" won!"<<endl;
            out<<endl<<p.getNme1()<<" lost!"<<endl;
            out<<p.getNme2()<<" score: "<<ps2<<endl;
            out<<p.getNme1()<<" score: "<<ps1<<endl;
        //    bin.write(name2, sizeof(name2));
          //  bin.write(reinterpret_cast<char *>(ps2), sizeof(ps2));
