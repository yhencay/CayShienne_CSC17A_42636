...
int main(int argc, char** argv) {
    ...
    //Declare Variables
    Player plyNum;
    const int FULSIZE=plyNum.getSIZE();
    const short HAFSIZE=plyNum.gtCSIZE();
    
    char start, player, discard;            //Start game, choose player, discard pairing
    int gmPly1=0, gmPly2=0,                 //Game Play counter
        cntr1=1, cntr2=1;                   //Count for array number
    int trsh1[HAFSIZE]={}, 
        trsh2[HAFSIZE]={};                  //Trash array - where discarded cards are put in
    ...
    cout<<"\nROUND 1 - Discard all pairs!"<<endl<<endl;
