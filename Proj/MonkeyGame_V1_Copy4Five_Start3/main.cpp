...
int main(int argc, char** argv) {
    ...
    char player1[NSIZE], player2[NSIZE],    //Player 1 and Player 2 C-String
         start, sort, player, discard;      //Start game, choose player, discard pairing
    ...
    bool x=true, y=true, z=true,            //LOOPS: x-play game, y-choose player, z-sorting cards
    ...
    Card *deck=filDeck(size, stand, in, "deck.txt");    //Fill deck fri=om cards in file
